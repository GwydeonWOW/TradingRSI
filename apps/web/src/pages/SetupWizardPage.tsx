      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-lg border border-border bg-bg-secondary p-6">
          <div className="mb-4 rounded-lg border border-accent/20 bg-accent/5 px-3 py-2 text-xs text-text-muted">
            No se han encontrado usuarios en el sistema. El primer usuario registrado sera administrador.
          </div>
        ...
        <p className="mt-4 text-center text-xs text-text-muted">
          Despues de crear el administrador, podras acceder a todas las funciones del sistema.
        </p>
      </div>
    </div>
  );
