      ...
      <div className="ml-auto flex items-center gap-3">
        {user && (
          <>
            ...
            <span className="hidden items-center gap-1 text-xs text-text-muted lg:inline-flex">
              <Shield size={12} />
            ...
            <button
              type="button"
              onClick={logout}
              className="flex items-center gap-1 rounded-md px-2 py-1 text-xs text-text-secondary hover:bg-bg-hover hover:text-text-primary"
            >
              <LogOut size={14} />
